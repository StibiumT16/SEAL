...
# - $BART_FILES/bart.base/model.pt - https://dl.fbaipublicfiles.com/fairseq/models/bart.base.tar.gz (decompress)

CUDA_VISIBLE_DEVICES=0 fairseq-train \
  "${DATASET}"/bin \
  --finetune-from-model "${BART_FILES}"/bart.base/model.pt \
  --arch bart_base \
  --task translation \
